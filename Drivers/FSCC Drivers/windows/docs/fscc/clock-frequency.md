...
_If you are receiving timeout errors when using slow data rates you can bypass the safety checks by using the [`FSCC_ENABLE_IGNORE_TIMEOUT`](../ignore-timeout.md) option._
