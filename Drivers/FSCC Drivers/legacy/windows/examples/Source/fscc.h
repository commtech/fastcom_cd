...
#define  IOCTL_FSCCDRV_CANCEL_STATUS		0x8300213C	////causes a blocked status request to return canceled
...
#define IOCTL_FSCCDRV_SET_PROGBITS          0x830021ec
#define IOCTL_FSCCDRV_GET_PROGBITS          0x830021f0
