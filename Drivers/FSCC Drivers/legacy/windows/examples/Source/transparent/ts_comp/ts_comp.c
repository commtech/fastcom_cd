...
ts_comp.c	-- a program to compare two files
		-- it is assumed that the files were generated with
		-- read (possibly with shifter) and write_random

  usage:

  ts_comp rxfile comparefile
